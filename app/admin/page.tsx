...
import { Users, BookOpen, BookCheck, AlertTriangle, Clock, DollarSign, Shield, UserCog } from "lucide-react"
  ...
  return (
    <div className="min-h-screen gradient-bg">
      ...
      <main className="container mx-auto px-4 py-8">
        {/* Hero Section */}
        <div className="mb-10">
          <h1 className="text-4xl font-bold text-foreground mb-2">Welcome, {user.full_name} — System Overview</h1>
        ...
        <div className="glass-card rounded-2xl p-6 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
            <Link href="/admin/users">
              <StatCard title="Total Users" value={stats.users.total} icon={Users} iconColor="text-blue-400" />
            </Link>
            <Link href="/admin/users?role=student">
              <StatCard title="Students" value={stats.users.students} icon={Users} iconColor="text-green-400" />
            </Link>
            <Link href="/admin/users?role=faculty">
              <StatCard title="Faculty" value={stats.users.faculty} icon={UserCog} iconColor="text-purple-400" />
            </Link>
            <Link href="/admin/users?role=librarian">
              <StatCard title="Librarians" value={stats.users.librarians} icon={BookOpen} iconColor="text-cyan-400" />
            </Link>
            <Link href="/admin/users?role=admin">
              <StatCard title="Admins" value={stats.users.admins} icon={Shield} iconColor="text-accent" />
            </Link>
          </div>
        </div>
