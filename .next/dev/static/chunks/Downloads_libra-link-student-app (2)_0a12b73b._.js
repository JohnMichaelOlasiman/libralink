...
"[project]/Downloads/libra-link-student-app (2)/components/reservation-card.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/Downloads/libra-link-student-app (2)/components/reservations-client.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ReservationsClient({ initialReservations }) {
    ...
    const handleFulfill = async (id)=>{
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$libra$2d$link$2d$student$2d$app__$28$2$292f$lib$2f$actions$2f$data$3a$73eb7e__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["fulfillReservation"])(id);
        if (!result.error) {
    ...
    const handleCancel = async (id)=>{
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$libra$2d$link$2d$student$2d$app__$28$2$292f$lib$2f$actions$2f$data$3a$fb5dee__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["cancelReservation"])(id);
        if (!result.error) {
            setReservationList(reservationList.map((res)=>res.id === id ? {
                    ...res,
                    status: "cancelled"
...
_s(ReservationsClient, "Wh9PQ6DHOsfLZv/xAlYA5j8h5lU=");
_c = ReservationsClient;
var _c;
__turbopack_context__.k.register(_c, "ReservationsClient");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=Downloads_libra-link-student-app%20%282%29_0a12b73b._.js.map